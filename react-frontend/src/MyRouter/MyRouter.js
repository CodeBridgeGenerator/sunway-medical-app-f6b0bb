...
import SingleAdmissionscorepopulatedtableCsvPage from "../components/AdmissionscorepopulatedtableCsvPage/SingleAdmissionscorepopulatedtableCsvPage";
import AdmissionscorepopulatedtableCsvProjectLayoutPage from "../components/AdmissionscorepopulatedtableCsvPage/AdmissionscorepopulatedtableCsvProjectLayoutPage";
import SingleAdmissionsdiagnosescorepopulatedtableCsvPage from "../components/AdmissionsdiagnosescorepopulatedtableCsvPage/SingleAdmissionsdiagnosescorepopulatedtableCsvPage";
import AdmissionsdiagnosescorepopulatedtableCsvProjectLayoutPage from "../components/AdmissionsdiagnosescorepopulatedtableCsvPage/AdmissionsdiagnosescorepopulatedtableCsvProjectLayoutPage";
import SingleLabscorepopulatedtableCsvPage from "../components/LabscorepopulatedtableCsvPage/SingleLabscorepopulatedtableCsvPage";
import LabscorepopulatedtableCsvProjectLayoutPage from "../components/LabscorepopulatedtableCsvPage/LabscorepopulatedtableCsvProjectLayoutPage";
import SinglePatientcorepopulatedtableCsvPage from "../components/PatientcorepopulatedtableCsvPage/SinglePatientcorepopulatedtableCsvPage";
import PatientcorepopulatedtableCsvProjectLayoutPage from "../components/PatientcorepopulatedtableCsvPage/PatientcorepopulatedtableCsvProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/admissionscorepopulatedtableCsv/:singleAdmissionscorepopulatedtableCsvId" exact element={<SingleAdmissionscorepopulatedtableCsvPage />} />
<Route path="/admissionscorepopulatedtableCsv" exact element={<AdmissionscorepopulatedtableCsvProjectLayoutPage />} />
<Route path="/admissionsdiagnosescorepopulatedtableCsv/:singleAdmissionsdiagnosescorepopulatedtableCsvId" exact element={<SingleAdmissionsdiagnosescorepopulatedtableCsvPage />} />
<Route path="/admissionsdiagnosescorepopulatedtableCsv" exact element={<AdmissionsdiagnosescorepopulatedtableCsvProjectLayoutPage />} />
<Route path="/labscorepopulatedtableCsv/:singleLabscorepopulatedtableCsvId" exact element={<SingleLabscorepopulatedtableCsvPage />} />
<Route path="/labscorepopulatedtableCsv" exact element={<LabscorepopulatedtableCsvProjectLayoutPage />} />
<Route path="/patientcorepopulatedtableCsv/:singlePatientcorepopulatedtableCsvId" exact element={<SinglePatientcorepopulatedtableCsvPage />} />
<Route path="/patientcorepopulatedtableCsv" exact element={<PatientcorepopulatedtableCsvProjectLayoutPage />} />
