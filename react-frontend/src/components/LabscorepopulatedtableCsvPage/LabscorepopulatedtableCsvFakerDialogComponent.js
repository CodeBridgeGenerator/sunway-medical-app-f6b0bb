...
import labscorepopulatedtableCsvFakerFactory from "./labscorepopulatedtableCsvFakerFactory";
...
const LabscorepopulatedtableCsvFakerDialogComponent = (props) => {
...
client.service("admissionscorepopulatedtableCsv")
    ...
    const onRun = async () => {
        let fakeData = labscorepopulatedtableCsvFakerFactory(props.user,fakerCount,patientidIds,admissionidIds);

        setLoading(true);
        const promises = fakeData.map((elem) => client.service("labscorepopulatedtableCsv").create(elem));
...
export default connect(mapState, mapDispatch)(LabscorepopulatedtableCsvFakerDialogComponent);
