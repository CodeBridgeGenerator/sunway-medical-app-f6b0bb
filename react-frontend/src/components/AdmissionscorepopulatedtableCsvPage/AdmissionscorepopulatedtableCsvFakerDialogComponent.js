...
import admissionscorepopulatedtableCsvFakerFactory from "./admissionscorepopulatedtableCsvFakerFactory";
...
const AdmissionscorepopulatedtableCsvFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        let fakeData = admissionscorepopulatedtableCsvFakerFactory(props.user,fakerCount,patientidIds);

        setLoading(true);
        const promises = fakeData.map((elem) => client.service("admissionscorepopulatedtableCsv").create(elem));
...
export default connect(mapState, mapDispatch)(AdmissionscorepopulatedtableCsvFakerDialogComponent);
